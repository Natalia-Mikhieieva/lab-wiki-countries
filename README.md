...
The CSS styling should be done using Bootstrap. Check how the _Bootstrap CSS className names_ are applied for styling in the `example.html` and refer to Bootstrap [docs](https://getbootstrap.com) for additional details.
